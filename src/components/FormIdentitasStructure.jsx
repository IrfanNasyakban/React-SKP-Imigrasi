...
const FormIdentitasStructure = () => {
  ...
  const saveIdentitasStructure = async (e) => {
    e.preventDefault();
    ...
    try {
      const response = await axios.post("https://api-imigrasi.sucofindo-arsip.my.id/identitas-structure", jsonData, {
        headers: {
      ...
      if (newId) {
        navigate(`/form-rhk-structure/${newId}`);
      } else {
      ...
      >
        <div className="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
          <form
            ...
            onSubmit={saveIdentitasStructure}
          >
...
export default FormIdentitasStructure;
